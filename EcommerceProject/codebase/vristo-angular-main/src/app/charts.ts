...
export class ChartsComponent {
    ...
    initCharts() {
        ...
        this.pieChart = {
            ...
            colors: ['#FE006F', '#805dca', '#00ab55', '#e7515a', '#e2a03f'],
            responsive: [
                {
                    breakpoint: 480,
                    options: {
        ...
        this.polarAreaChart = {
            ...
            colors: ['#FE006F', '#805dca', '#00ab55', '#e7515a', '#e2a03f', '#2196f3', '#3b3f5c'],
            stroke: {
                show: false,
            },
            responsive: [
