...
const routes: Routes = [
    {
        ...
        title: 'Account Setting | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    { path: 'users/profile', component: ProfileComponent, title: 'User Profile | HustleHub - Multipurpose Tailwind Dashboard Template' },
];
@NgModule({
