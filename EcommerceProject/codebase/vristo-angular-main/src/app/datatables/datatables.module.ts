...
const routes: Routes = [
    { path: 'datatables/basic', component: BasicDatatableComponent, title: 'Basic Table | HustleHub - Multipurpose Tailwind Dashboard Template' },
    { path: 'datatables/advanced', component: AdvancedDatatableComponent, title: 'Advanced Table | HustleHub - Multipurpose Tailwind Dashboard Template' },
    { path: 'datatables/skin', component: SkinDatatableComponent, title: 'Skin Table | HustleHub - Multipurpose Tailwind Dashboard Template' },
    {
        path: 'datatables/order-sorting',
        component: OrderSortingDatatableComponent,
        title: 'Order Sorting Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/columns-filter',
        component: ColumnsFilterDatatableComponent,
        title: 'Columns Filter Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/multi-column',
        component: MultiColumnDatatableComponent,
        title: 'Multi Column Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/multiple-tables',
        component: MultiTablesComponent,
        title: 'Multiple Tables | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/alt-pagination',
        component: AltPaginationDatatableComponent,
        title: 'Alternative Pagination | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/checkbox',
        component: CheckboxDatatableComponent,
        title: 'Checkbox Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/range-search',
        component: RangeSearchDatatableComponent,
        title: 'Range Search Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/export',
        component: ExportDatatableComponent,
        title: 'Export Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/sticky-header',
        component: StickyHeaderDatatableComponent,
        title: 'Sticky Header | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/clone-header',
        component: CloneHeaderDatatableComponent,
        title: 'Clone Header Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
    {
        path: 'datatables/column-chooser',
        component: ColumnChooserDatatableComponent,
        title: 'Column Chooser Table | HustleHub - Multipurpose Tailwind Dashboard Template',
    },
];
@NgModule({
    imports: [
